...
public class ProductModel {
    ...
    //used by view activity to add a new Product when there is no image
    public ProductModel(String name, String description, int quantity, int price, int categoryId, int supplierId) {
        this.price = price;
    ...
    //used by view activity to add a new Product when there is an image
    public ProductModel(String name, String description, int price, int quantity, int categoryId, int supplierId, int imageId) {
        this.price = price;
        this.quantity = quantity;
