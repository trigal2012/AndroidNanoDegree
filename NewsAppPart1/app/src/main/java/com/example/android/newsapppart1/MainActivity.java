...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Item>> {
    ...
    private static final String GUARDIAN_REQUEST_URL =
            "https://content.guardianapis.com/sport/tour-de-france-2018?&show-tags=contributor&api-key=84dedd1d-bf23-46ca-ab4d-ef062a844f5f";
    ...
    public Loader<List<Item>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new ItemLoader(this, GUARDIAN_REQUEST_URL);
    }
