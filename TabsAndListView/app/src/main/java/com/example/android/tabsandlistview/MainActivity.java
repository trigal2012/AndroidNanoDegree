...
*/
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PlaceholderFragment1(), "Create Order ASC");
        adapter.addFragment(new PlaceholderFragment2(), "Alpha by breed ASC");
        adapter.addFragment(new PlaceholderFragment3(), "Alpha by name ASC");
    ...
    private void insertPet() {
        ...
        Log.i("main activity", "insert pet done");
    }
